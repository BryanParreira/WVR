...
const CMDS: Record<string, () => Line[]> = {
  ...
  pricing: () => [
    ...
    { text: "" },
    { text: "  Foundation   $1,500/mo" },
    { text: "  ↳ Core web presence + security baseline" },
    { text: "" },
    { text: "  Growth       $2,500/mo   ★ most popular" },
    { text: "  ↳ AI automation + full marketing stack" },
    { text: "" },
    { text: "  Ecosystem    $5,000+/mo" },
    { text: "  ↳ Custom AI agents + Zero Trust + bespoke dev" },
    { text: "" },
    { text: "  Enterprise   Custom Quote" },
    { text: "  ↳ Dedicated team, SLAs, multi-year contracts" },
    { text: "" },
