...
export const POSTS: Post[] = [
  {
    ...
    title: "Vulnerability Scan vs. Real Penetration Test — And Why the Difference Matters for What You're Paying For",
    excerpt:
