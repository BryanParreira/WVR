...
export const metadata: Metadata = {
  title: "About",
  description:
    "WebVisionRank is a hybrid AI tech agency bridging Agentic AI, Zero-Trust cybersecurity, and elite custom development.",
}
    ...
    <SiteLayout>
      ...
      <section className="pt-12 pb-12 px-6 sm:pt-20 sm:pb-16 bg-canvas">
        <div className="mx-auto max-w-[1200px]">
          <AnimateIn>
            <p className="caption-uppercase mb-3">Our Mission</p>
      ...
      <section className="py-10 px-6 sm:py-14 border-t border-b border-hairline bg-canvas">
        <AnimateIn className="mx-auto max-w-[1200px]">
          <blockquote className="text-[22px] font-normal text-ink leading-[1.4] tracking-[-0.01em] max-w-3xl">
            &ldquo;We don&apos;t just build websites or run campaigns. We architect digital ecosystems
            that generate revenue, repel threats, and evolve with your business.&rdquo;
          </blockquote>
          <p className="text-[13px] text-muted mt-4">— WebVisionRank Founding Principle</p>
        </AnimateIn>
      </section>
      ...
      <section className="py-12 px-6 sm:py-20 bg-canvas">
        <div className="mx-auto max-w-[1200px]">
          <AnimateIn className="mb-12">
            <p className="caption-uppercase mb-3">What Drives Us</p>
      ...
      <section className="py-12 px-6 sm:py-20 border-t border-hairline bg-canvas">
        <div className="mx-auto max-w-[1200px] grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16 items-start">
          <AnimateIn direction="right">
            <p className="caption-uppercase mb-3">Why WebVisionRank</p>
